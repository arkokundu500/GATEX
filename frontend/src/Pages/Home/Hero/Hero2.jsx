...
import bgImg from '../../../assets/home/banner3.jpg'
  ...
  return (
    <div className='min-h-screen bg-cover' style={{backgroundImage : `url(${bgImg})`}}>
        <div className='min-h-screen flex justify-start pl-11 items-center text-white bg-black bg-opacity-60'>
            ...
            <p className='md:text-4xl text-2xl'>Gate Classes are running now for branches </p>
            <h3 className='md:text-7xl text-4xl font-bold'>CS | IT | ECE | ME | CE</h3>
