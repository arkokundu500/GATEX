...
import img from "../../assets/home/teach1.jpg"
  ...
  return (
   ...
   {
    instructors ? <> 
    <div className='grid mb-28 md:grid-cols-2 lg:grid-cols-4 w-[90%] gap-6 mx-auto mt-20'>
      {
        instructors?.slice(0,4).map((instructor,i) => (
          <div className='flex dark:text-white hover:translate-y-2 duration-200 cursor-pointer flex-col shadow-md dark:shadow-gray-100  rounded-md'>
            <div className='flex-col flex gap-6 md:gap-8'>
              <img className='rounded-full border-4 border-gray-300 h-24 w-24 mx-auto' src={instructor.photoUrl || `${img}` } alt="" />

              <div className='flex flex-col text-center'>
                <p className='font-medium txt-lg dark:text-white text-gray-800'> {instructor.name}</p>
